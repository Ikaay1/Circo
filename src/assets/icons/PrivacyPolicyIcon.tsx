...
const PrivacyPolicyIcon = () => (
  <Icon viewBox="0 0 24 24" width={"1.3em"} height={"1.3em"}>
    ...
    >
      ...
      />
      <path
        d="M20 21.9993H16C14.4 21.9993 14 21.5993 14 19.9993V19.1992C14 17.5992 14.4 17.1992 16 17.1992H20C21.6 17.1992 22 17.5992 22 19.1992V19.9993C22 21.5993 21.6 21.9993 20 21.9993Z"
        stroke="white"
        strokeOpacity="0.4"
        strokeWidth="1.5"
        strokeLinecap="round"
