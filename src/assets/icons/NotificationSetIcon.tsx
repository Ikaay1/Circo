  ...
  <Icon viewBox="0 0 24 24" width={"1.3em"} height={"1.3em"}>
    ...
    >
      ...
      <g opacity="0.4">
        ...
        />
        <path
          d="M15.5697 12.6492C17.0057 12.6492 18.1697 11.4852 18.1697 10.0492C18.1697 8.61328 17.0057 7.44922 15.5697 7.44922C14.1338 7.44922 12.9697 8.61328 12.9697 10.0492C12.9697 11.4852 14.1338 12.6492 15.5697 12.6492Z"
          stroke="currentColor"
          strokeOpacity="0.4"
          strokeWidth="1.5"
          strokeMiterlimit="10"
...
export default NotificationSetIcon;
