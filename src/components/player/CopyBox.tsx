...
const CopyBox = ({ link, type }: { link: string; type?: string }) => {
          ...
          <Box
            ...
            onClick={() => {
              if (link.includes("channel")) {
                if (icon === "whatsapp") {
                  window.open(
                    `https://wa.me/?text=Hi%20use%20this%20link%20to%20checkout%20my%20circo%20${
                      type === "stream" ? "livestream" : "video"
                    }%20${process.env.NEXT_PUBLIC_FEURL}${link}`
                  );
                } else if (icon === "ig") {
                  window.open(
                  ...
                  window.open(
                    `https://twitter.com/intent/tweet?text=Hi%20use%20this%20link%20to%20checkout%20my%20circo%20${
                      type === "stream" ? "livestream" : "video"
                    }%20${process.env.NEXT_PUBLIC_FEURL}${link}`
                  );
