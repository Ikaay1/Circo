    ...
    <Box>
      ...
      >
        ...
        <Text
          ...
          mt={".9rem"}
        >
          You take care of your contnet choice, and we’ll take care of the rest.
        </Text>
        <Box>
          <Box
            mt={"3.5rem"}
          ...
          >
            {cliquePlatformData1.map(({ key, name, detail, image }) => (
          ...
          >
            {cliquePlatformData2.map(({ key, name, detail, image }) => (
